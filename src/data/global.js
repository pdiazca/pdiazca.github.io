export default {
    globalData: {
        name: "Pablo Diaz",
        tagline: "Digital designer & front-end developer.",
        skillsListOne: ["UI/UX Design", "Front End Development", "Product Design", "Brand Identity"],
        skillsListTwo: ["CMS Integrations", "Web and Email Design", "E-Commerce", "Project Management"],
        info: {
        ...
        socialLinks: [{
            site: "Behance",
            link: "https://www.behance.net/pablo_diaz",
            icon: "fa fa-behance"
        }, {
            site: "Codepen",
            link: "https://codepen.io/pablodiaz/",
            icon: "fa fa-codepen"
        }, {
            site: "Linkedin",
            link: "https://www.linkedin.com/in/pablodiazca/",
            icon: "fa fa-linkedin"
        }, {
            site: "Instagram",
            link: "https://www.instagram.com/flyingcircuss/",
            icon: "fa fa-instagram"
        }, {
            site: "Medium",
            link: "https://medium.com/@pablodiaz_ca",
            icon: "fa fa-medium"
        }]
    }
}
